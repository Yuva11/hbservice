...
public class TrendingTag implements Serializable {
	...
	/*@Column(name = "all_bangalore")
	private String all_bangalore;
	
	
	*/
	/*@Column(name = "hsr_layout")
	private String hsr_layout;

	@Column(name = "kormangala")
	private String kormangala;
	
	@Column(name = "whitefield")
