...
public class SpearSMSUtility {
	...
	public SpearSMSUtility() {
		try {
			dataGetFromProperty.getPropValues();
			working_key=dataGetFromProperty.working_key;
			sender_id=dataGetFromProperty.sender_id;
			api_url=dataGetFromProperty.api_url;
		...
		System.out.println("---u----"+dataGetFromProperty.working_key);
	    ...
	    public static void main(String ar[]) throws KeyManagementException, NoSuchAlgorithmException, IOException
	     {
	    	...
	    	// sms.send_sms("7026757618", "hi", "alerts.spearcommunication.in");
	    	 ...
	    	 String ss=sms.process_sms("8041301414", "Dear, we received order for bheem SIngh customer name-XXXXXXXXXXX mobile no XXXXXXXXXXX address-XXXXXXXXXXXXXXXXXXXXXXXX order id-XXXXXXXXXX.Thanks Hungry bells-Discover your taste", "", "", "");
	    	 System.out.println("smsms--- "+ss);
	    	 }
	    	 catch(Exception ek)
	    	 {
	    		 ek.printStackTrace();
